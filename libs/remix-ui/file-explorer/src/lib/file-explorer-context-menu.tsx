...
export const FileExplorerContextMenu = (props: FileExplorerContextMenuProps) => {
  const { actions, createNewFile, createNewFolder, deletePath, renamePath, hideContextMenu, publishToGist, copy, paste, runScript, emit, pageX, pageY, path, type, ...otherProps } = props
